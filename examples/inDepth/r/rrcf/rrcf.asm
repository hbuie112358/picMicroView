...
;manual. Rrcf rotates the contents of register f right through the carry bit.
;
;;;;;;; Program hierarchy ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; Mainline
...
;Example 1:
	...
	rrcf	REG1, 0, 1	;Using banked addressing, rotate right through carry
				;REG1, place result in wreg

;Example 2:
;Case 1:
	
	lfsr	0, 0x2c2	;Place 0x0c2 in FSR0
	...
	rrcf	INDF0, 1, 1	;Rotate right through carry value in register pointed to
				;by FSR0, place result back in register, carry bit is 
				;loaded into bit 7

;Case 2:
	
	movlw	0x39		;Place 0xb9 into wreg
	movwf	INDF0		;Copy wreg to register at address pointed to by FSR0
	rrcf	INDF0, 1, 1	;Rotate right through carry value in register pointed to
				;by FSR0, place result back in register, carry bit is 
				;loaded into bit 7
