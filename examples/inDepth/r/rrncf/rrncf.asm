...
;Example 1:
	...
	rrncf	REG1, 0, 1	;Using banked addressing, rotate right REG1, place 
				;result in wreg

;Example 2:
;Case 1:
	
	lfsr	0, 0x3c2	;Place 0x3c2 in FSR0
	movlw	0x3a		;Place 0x3a in wreg
	movwf	INDF0		;Copy wreg to register at address pointed to by FSR0
	rrncf	INDF0, 1, 1	;Rotate right value in register pointed to by FSR0, place
				;result back in register, bit 0 is loaded into bit 7 
