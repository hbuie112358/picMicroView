...
HERE2		bnov	$ + OFFSET	;If overflow bit not set, branch to HERE2 + OFFSET
...
NO_N		nop
		...
		btg	STATUS, 3	;Branches here after $ + OFFSET since OFFSET is 10
					;and overflow bit is not set.
		nop			
		nop			
		nop
		nop
		btg	STATUS, 3
HERE3		bnov	$ - OFFSET	;If overflow bit not set, branch to HERE3 - OFFSET
